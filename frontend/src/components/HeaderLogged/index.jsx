...
import { openSidebar, closeSidebar, selectSidebar } from "../../redux/slices/popUpSlice"
import { loggout, selectUser } from "../../redux/slices/userSlice"
...
export function HeaderLogged() {
    ...
    return (
        <Container>
            ...
            <SidebarButton onClick={isCloseSidebar} className={sidebarState ? 'active' : ''} >
            ...
            <button className="header__user" onClick={() => setIsDropDown(!isDropDown)}>
                {user.name}
                <ArrowDropDownIcon className="header__userDropDown" />
            </button>

            <MobileMenu data-active={isDropDown} onClick={() => setIsDropDown(!isDropDown)}>
            ...
            {isDropDown && (
                <div className="header__dropDownContainer" data-close onClick={dropDown}>
                    <div className="header__dropDownContent">
                        ...
                        <button onClick={loggoutUser} className="header__dropDownContent__option">
                            LogOut
                        </button>
